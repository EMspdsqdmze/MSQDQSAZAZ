...
// Use /tmp/data by default when running on Netlify, unless DATA_DIR is set.
const DEFAULT_DATA_DIR = process.env.NETLIFY ? path.join("/tmp", "data") : path.join(process.cwd(), "data");
